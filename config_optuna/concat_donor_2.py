def suggest_params(trial):
	"""
	This method is used to sample hyperparameters using the Optuna trial object.
	:param trial: Optuna trial object
	:return: parameters
	"""
	# To enable conditional sampling, some hyperparameters are sampled outside the dictionary.
	# Sampling within the dictionary increase the cleanliness of the code and is therefore preferred.
