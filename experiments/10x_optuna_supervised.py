...
params_experiment = {
    'study_name': f'10x_{args.donor}_{args.model}_filtered_{args.filter_non_binder}_split_{args.split}_supervised',
    'comet_workspace': None,
    'model_name': args.model + '_supervised',
    'label_key': 'binding_label',
    'balanced_sampling': 'clonotype',
    'metadata': ['binding_name', 'clonotype', 'donor'],
    'save_path': os.path.join(os.path.dirname(__file__), '..', 'optuna',
                              f'10x_{args.donor}_{args.model}_split_{args.split}_supervised')
}
...
params_optimization = {
    'name': 'supervised',
    'prediction_column': 'binding_label',
}
