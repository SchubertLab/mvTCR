...
def correct_params(params):
	...
	"""
	params['loss_weights'] = [params['loss_weights_1'], params['loss_weights_2'], params['loss_weights_3']]
	params['dec_hdim'] = [params['dec_hdim_1'], params['dec_hdim_2']]
	params['enc_hdim'] = [params['enc_hdim_1'], params['enc_hdim_2']]
	params['vdj_dec_layers'] = [params['vdj_dec_layer_1'], params['vdj_dec_layer_2']]
...
def objective(params, checkpoint_dir=None, adata=None):
	...
	model = tcr.models.deep_tcr.DeepTCR(
		adatas=[adata],
		params=params,
		seq_model_hyperparams=params['seq_model_hyperparams'],
		names=['10x']
	)
	...
	n_epochs = args.n_epochs * params['batch_size'] // 2048  # to have same numbers of iteration
...
adata = sc.read_h5ad('../data/10x_CD8TC/v6_deep_tcr.h5ad')
